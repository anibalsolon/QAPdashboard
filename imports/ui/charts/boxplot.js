...
export default function renderBoxplot(gam, domid){
  // using an array of arrays with
  // gam[n][2] 
  // where n = number of columns in the csv file 
  // gam[i][0] = name of the ith column
  // gam[i][1] = array of values of ith column
...
//create critical area so box function won't add
//quartle to the data
box();
...
d3.csv("/data.csv", function(error, csv) {
  ...
  //start boxplot
	...
	var svg = d3.select(individualAnatBoxplot).append("svg")
